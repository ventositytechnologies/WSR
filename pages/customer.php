                                ...
                                <div class="modal-body">
                                    <form action="savecustomer.php" method="post" class = "form-group">
                                        <div id="ac">
                                            ...
                                            <span>GST : </span><input type="text" name="contact" class = "form-control" />
                                            <span>D.L.No. : </span><input type="text" name="memno" class = "form-control" />
