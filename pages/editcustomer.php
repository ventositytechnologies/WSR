...
for($i=0; $row = $result->fetch(); $i++){
	...
	<form action="saveeditcustomer.php" method="post" class = "form-group">
		<div id="ac">
			...
			<span>GST : </span><input type="text" name="contact" class = "form-control" value="<?php echo $row['contact']; ?>" />
			<span>D.L. No. : </span><input type="text" name="memno" class = "form-control" value="<?php echo $row['membership_number']; ?>" />
